        ...
        try:
            ...
            async for message in pubsub.listen():
                ...
                try:
                    ...
                    # 检查事件是否过期
                    if event_data.expire_at and event_data.expire_at < (time.time() * 1000):
                    ...
                    if mode == "response":
                        ...
                        if future and not future.done():
                            ...
                            if response.get("success"):
                                ...
                                future.set_exception(Exception(response.get("error", "未知错误")))
                    ...
                    for handler in handlers:
                        try:
                            ...
                            if mode == "request" and event_data.id:
                                ...
                                await self.redis.publish(response_channel, response_data.to_json())
                        except Exception as e:
