...
from .decorators import (
    get_pending_tools, get_instance_tools, set_initialized, is_initialized
)
...
def init_tools() -> bool:
    ...
    try:
        ...
        logger.info(f"工具系统初始化完成，共注册 {total_tools} 个工具 "
...
def get_tools_summary() -> Dict[str, Any]:
    ...
    try:
        summary = {
            ...
            "instance_tools_count": sum(len(tools) for tools in get_instance_tools().values()),
